 ...
 *   The element from which the specifåied event will be dispatched.  eventSource
...
function runBaseTests() {
  ...
  suite('Base Automation Tests for px-spinner', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-spinner fixture is created', function() {
